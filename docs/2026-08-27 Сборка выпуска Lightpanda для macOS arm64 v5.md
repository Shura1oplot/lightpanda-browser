...
Сборка для Linux не входит в этот этап. Для нее действует [отдельная инструкция по нативной сборке на Timeweb](2026-08-27%20%D0%A1%D0%B1%D0%BE%D1%80%D0%BA%D0%B0%20Lightpanda%20%D0%B4%D0%BB%D1%8F%20Linux%20%D0%BD%D0%B0%20Timeweb%20v9.md).
